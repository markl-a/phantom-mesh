...
mod tests {
    ...
    fn test_generate_systemd_unit() {
        ...
        assert!(unit.contains(&format!("Description=Phantom Mesh Worker ({})", config.worker_name)));
    ...
    fn test_generate_windows_service() {
        ...
        assert!(script.contains(&format!("$ServiceName = \"Phantom MeshWorker_{}\"", config.worker_name)));
