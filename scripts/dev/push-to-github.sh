...
cd "${PROJECT_DIR:-C:\Users\<user>\path\to\LLM-Cluster-Project\core}"
...
- Port assignments: node-c=7879, node-d=7880, node-b=7881, iPhone=7882, Android=7883-7884
- Hub IP: 192.0.2.10:7878
...
echo ""
echo "Mac worker:     cd core && cargo build --release && ./target/release/core worker --hub http://192.0.2.10:7878 --name mac-worker --port 7879"
