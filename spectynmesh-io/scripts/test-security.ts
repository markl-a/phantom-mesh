...
// HttpOnly cookie (`spectyn_oauth_nonce`) set in `authStart` / `webStart`,
...
const NONCE_COOKIE = "spectyn_oauth_nonce";

function getCookieValue(setCookie: string | null, name: string): string | null {
  if (!setCookie) return null;
  // Hono uses Set-Cookie like: `spectyn_oauth_nonce=abc; HttpOnly; Path=/; ...`
