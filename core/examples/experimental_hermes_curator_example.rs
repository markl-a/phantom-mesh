//! Example: experimental-hermes-curator (H1 + H2).
//!
//! Demonstrates the public surface of `phantom_mesh::hermes::curator` and
//! `phantom_mesh::hermes::skill` without making any network calls:
//!
...
fn main() {
    ...
    println!("experimental-hermes-curator OK");
}
