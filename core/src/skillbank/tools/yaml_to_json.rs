//! `skill_yaml_to_json` — parse a YAML string into JSON.
//!
//! Round-trip pair with `skill_json_to_yaml`. Uses the optional
//! `serde_yaml` dep that the `experimental-tools` feature
