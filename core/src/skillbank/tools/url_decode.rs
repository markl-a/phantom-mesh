//! `skill_url_decode` — reverse of `skill_url_encode`.
//!
...
impl SkillTool for UrlDecode {
    ...
    fn schema(&self) -> Value {
        json!({
            "type": "function",
            "function": {
                "name": "skill_url_decode",
                "description": "Decode percent-encoded `text`. Round-trip pair with skill_url_encode. \
