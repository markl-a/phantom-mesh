//! Hermes Skill Document execution runtime.
//!
//! Consumes a [`crate::hermes::skill::SkillDocument`] (parsed by H2) and
...
//!
//! Gated behind the `experimental-hermes-curator` cargo feature. Default
...
//! - No HermesRuntime/T2 integration yet — T10 is standalone.
...
use crate::hermes::skill::SkillDocument;
...
";
    ...
    fn parse_doc(input: &str) -> crate::hermes::skill::SkillDocument {
        crate::hermes::skill::parse_str(input).expect("parse test skill")
    }
...
",
    ...
    fn execute_sample_skill_from_docs_dry_run() {
        // Reads the H2 sample at docs/hermes-skills/sample-skill.md.
        ...
        let doc = crate::hermes::skill::parse_str(&raw).expect("parse sample-skill.md");
