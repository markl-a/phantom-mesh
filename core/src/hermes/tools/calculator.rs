//! `hermes_calculator` — safe arithmetic expression evaluator.
//!
//! Concept ported from hermes-agent's example calculator tool;
...
#[async_trait]
impl HermesTool for Calculator {
