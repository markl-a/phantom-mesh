//! `hermes_word_count_lines` — combined `wc`-style report on a string.
//!
//! Goes beyond `hermes_text_stats` by additionally returning:
...
#[async_trait]
impl HermesTool for WordCountLines {
    fn name(&self) -> &'static str {
        "hermes_word_count_lines"
    }
