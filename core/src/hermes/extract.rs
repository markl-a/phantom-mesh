...
//!
//! Gated behind `experimental-hermes-curator` so the default build pulls
...
use crate::hermes::skill::{serialize as serialize_skill, SkillDocument, SkillFrontmatter};
...
fn build_frontmatter(
    ...
    SkillFrontmatter {
        ...
        author: Some(format!("hermes-extractor/{}", verdict.rubric_version)),
    }
}
...
fn roundtrips_cleanly(doc: &SkillDocument) -> bool {
    ...
    match crate::hermes::skill::parse_str(&serialized) {
...
mod tests {
    ...
    use crate::hermes::curator::RUBRIC_VERSION;
    ...
    fn round_trip_extracted_failure_skill_serialize_parse_equal() {
        ...
        let reparsed = crate::hermes::skill::parse_str(&serialized).expect("re-parse ok");
