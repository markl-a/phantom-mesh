//! H1: Hermes-style Curator + LLM-as-judge.
//!
...
//!
//! Architectural inspiration only from the Hermes-agent-self-evolution
//! repo — NO code vendored (its license is missing → all rights reserved).
...
/// A1's [`crate::hermes::extract::extract_skill`] now routes the verdict
...
///
/// The real implementation lives in `hermes::extract` once A1 lands.
...
impl Curator {
    ...
    /// this function feature-flag agnostic — `experimental-hermes-memory`
