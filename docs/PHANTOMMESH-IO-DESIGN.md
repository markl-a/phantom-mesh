...
- 使用者可用
  ...
  [docs/COMMERCIAL-DESIGN.md](COMMERCIAL-DESIGN.md) §2 硬規則 #4）。
...
| 要把 broker 開源嗎？ | 要 — BSL 1.1 → 4 年後轉 Apache 2.0。與 docs/COMMERCIAL-DESIGN.md §7 相同的 Tailscale 模式。 |
