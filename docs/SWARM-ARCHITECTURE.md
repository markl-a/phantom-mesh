...
目前的 [INSTALL-IOS.md](./INSTALL-IOS.md) 說「iOS 只是一個瘦客戶端」。
...
*最後更新：2026-05-13。作者：phantom-mesh 維護者。與 [ARCHITECTURE.md](./ARCHITECTURE.md)（單節點）以及 [CLUSTER-SCALE.md](./CLUSTER-SCALE.md)（既有叢集運維）互為搭檔文件。*
