...
> "Apple Intelligence sent your prompt to Private Cloud Compute. Want it to go to YOUR Mac Studio instead? spectyn-mesh, 60 seconds."
...
| 0:10-0:18 | iPhone：長 prompt(看得到內容,真實隱私敏感)— 配 iOS Shortcuts 或 spectyn iOS app | "Type the same prompt..." |
...
| 0:57-0:60 | 結尾卡（End card）：spectyn-mesh logo + "Your PCC, your rules." | — |

## 預先錄製檢查清單

- [ ] m1 上 `spectyn mlx pull llama3-70b-instruct` 完成
- [ ] m1 上 `spectyn mlx serve --model llama3-70b-instruct` 跑著
- [ ] m1 在 Tailscale,iPhone 也是
- [ ] iOS Shortcut(或 spectyn iOS app v0.6.0+)設好,觸發 HTTPS POST 到 m1
